...
-- DELETE From table name where condition primary value = same value 

-- insert into staff (departmentname,deprt_code) values ("IT",001),("BCA",002),("CS",003),("MECH",004),("CIVIL",004);
